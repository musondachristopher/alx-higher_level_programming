...
class Chessboard:
    ...
    def remove_in_current_row(self):
        """Remove in the current row."""
        return self.cols.pop()

    def next_row_safe(self, col):
        """Check ifa the  current col in the next row is safe."""
        row = len(self.cols)
...
def solve(size):
    """Solves fully the the N queens problemm."""
